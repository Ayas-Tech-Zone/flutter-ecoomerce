                  ...
                  child: new Column(
                    ...
                    children: <Widget>[
                      ...
                      Padding(
                        ...
                        child: Text(
                            "Bottom line? Ecommerce is big and getting bigger. And navigating the ever-changing ecommerce terrain is a big challenge for small businesses used to the brick-and-mortar paradigm. So many factors impact your success online.",
                            style: _detailText),
                      ),
                      Padding(
                          ...
                          children: <Widget>[
                            ...
                            Row(
                              children: <Widget>[
                                ...
                                Padding(padding: EdgeInsets.only(left: 15.0)),
                                RadioButtonColor(Colors.blueAccent),
                                Padding(padding: EdgeInsets.only(left: 15.0)),
                                RadioButtonColor(Colors.redAccent),
                              ],
                            ),
                          ],
                        ),
                          ...
                          children: <Widget>[
                            ...
                            Padding(
                              padding: const EdgeInsets.only(
                                  ...
                                  left: 20.0),
                              child: Text(
                                  'Ecommerce is big and getting bigger. And navigating the ever-changing ecommerce terrain is a big challenge for small businesses used to the brick-and-mortar paradigm. So many factors impact your success online',
                                  style: _detailText),
                            ),
                            Center(
                              child: InkWell(
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            _buildRating('05 Jan 2022',
                                'Item delivered in good condition. I will recommend it',
                                (rating) {
                              setState(() {
                                this.rating = rating;
                              });
                            ...
                            _buildRating('30 Jan 2022', 'Great Products',
                                (rating) {
                              setState(() {
                                this.rating = rating;
                              });
                            ...
                            _buildRating(
                                '19 Feb 2022', 'Felxible and fast shopping',
                                (rating) {
                              setState(() {
                                this.rating = rating;
                              });
